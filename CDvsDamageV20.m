...
varNames = {'S1_V20', 'S2_V20', 'S3_V20', 'S4_V20', 'S5_V20', ...
            'S6_V20', 'S7_V20', 'S8_V20', 'S9_V20', 'S10MFSIDE_V20', 'S10MFUP_V20'};
...
xLabels = {'S1', 'S2', 'S3', 'S4', 'S5', 'S6', 'S7', 'S8', 'S9', 'S10'};
xData = 1:numShuttles;

figure('Name', 'Shuttlecock Aerodynamic Degradation at 20 m/s', 'Position', [100, 100, 800, 600]);
