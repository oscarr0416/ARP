...
varNames = {'S1_V10','S2_V10', 'S3_V10', 'S4_V10', 'S5_V10', ...
...
disp('--- Processing Shuttlecock Batch Data (10 m/s) ---');
...
figure('Name', 'Shuttlecock Aerodynamic Degradation at 10 m/s', 'Position', [100, 100, 800, 600]);
...
xticks(xData);
xticklabels(xLabels);
title('Drag Coefficient (C_D) vs. Shuttlecock Damage (10 m/s)');
